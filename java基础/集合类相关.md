...
## HashMap的底层实现
Map的最核心结构是table，是一个Node类型的数组，而Node的实现又是一个链表或者是一个红黑树的节点。如下图所示：
![HashMap实现](https://cdn.yuque.com/yuque/0/2018/png/102759/1529915531228-11fb7529-d2b1-48fc-bfc8-a65697fda608.png)
...
![resize过程](https://cloud.githubusercontent.com/assets/1736354/6958301/519be432-d93c-11e4-85bb-dff0a03af9d3.png)
代码实现如下：
```java
